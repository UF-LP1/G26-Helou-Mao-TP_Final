...
cListaFichas crarFichas()
{
	...
	cTumor* tumor2 = new cTumor(prostata, mediano, sist1, 15.0, 60.0, 4.0, 3, 1); 
	cTumor* tumor3 = new cTumor(cuelloUtero, pequenio, braqui1, 80.0, 150.0, 7.0, 3, 2); 
	cTumor* tumor4 = new cTumor(mama, pequenio, braqui3, 140.0, 150.0, 8.0, 5, 3); 
	cTumor* tumor5 = new cTumor(ojo, pequenio, braqui2, 20.0, 150.0, 6.0, 3, 1); 
	cTumor* tumor6 = new cTumor(vejiga, mediano, radio1, 20.0, 60.0, 2, 2, 1); 
	cTumor* tumor7 = new cTumor(tiroides, pequenio, sist2, 10.0, 60.0, 3.0, 2, 1); 
	cTumor* tumor8 = new cTumor(pancreas, mediano, radio2, 10.0, 60.0, 1.0, 6, 3); 
	cTumor* tumor9 = new cTumor(pulmon, pequenio, radio1, 20.0, 60.0, 2.0, 3, 1); 
	cTumor* tumor10 = new cTumor(riñon, grande, radio3, 10.0, 60.0, 1.0, 4, 2); 
	cTumor* tumor11 = new cTumor(nariz, pequenio, radio1, 5.0, 60.0, 5.0, 2, 0);
...
cListaTumores crearTumores()
{
	...
	cTumor* tumor1 = new cTumor(cabezayCuello, pequenio, braqui1, 60.0, 150.0, 5.0, 3, 1);
	cTumor* tumor2 = new cTumor(prostata, mediano, sist1, 55.0, 60.0, 4.0, 3, 1);
	cTumor* tumor3 = new cTumor(cuelloUtero, pequenio, braqui1, 60.0, 150.0, 7.0, 3, 2);
	cTumor* tumor4 = new cTumor(mama, pequenio, braqui3, 140.0, 150.0, 8.0, 5, 3);
	cTumor* tumor5 = new cTumor(ojo, pequenio, braqui2, 150.0, 150.0, 6.0, 3, 1);
	cTumor* tumor6 = new cTumor(vejiga, mediano, radio1, 45.0, 60.0, 2, 2, 1);
	cTumor* tumor7 = new cTumor(tiroides, pequenio, sist2, 60.0, 60.0, 3.0, 2, 1);
	cTumor* tumor8 = new cTumor(pancreas, mediano, radio2, 10.0, 60.0, 1.0, 6, 3);
	cTumor* tumor9 = new cTumor(pulmon, pequenio, radio1, 20.0, 60.0, 2.0, 3, 1);
	cTumor* tumor10 = new cTumor(riñon, grande, radio3, 10.0, 60.0, 1.0, 4, 2);
	cTumor* tumor11 = new cTumor(nariz, pequenio, radio1, 60.0, 60.0, 5.0, 2, 0);
	cListaTumores lista1;
	lista1 + *tumor1;
	lista1 + *tumor2;
